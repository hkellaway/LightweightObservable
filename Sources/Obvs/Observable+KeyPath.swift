...
public extension Observable {
    ...
    func bind<Root: AnyObject>(to keyPath: ReferenceWritableKeyPath<Root, T>, on object: Root) -> Disposable {
    ...
    func bind<Root>(to keyPath: ReferenceWritableKeyPath<Root, T?>, on object: Root) -> Disposable {
        subscribe { newValue, _ in
            object[keyPath: keyPath] = newValue
        }
    }
